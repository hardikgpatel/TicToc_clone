package com.aapki.hasi.SimpleClasses;
...
public class Variables {
   ...
   public static String gif_api_key1="giphy_api_key_here";
    ...
    public static final  String main_domain="http://tamildownload.in/";
    public static final String base_url="http://tamildownload.in/API-extended/";
    public static final String api_domain ="http://tamildownload.in/API-extended/index.php?p=";
